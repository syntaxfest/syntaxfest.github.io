...
\includegraphics[height=4cm]{syntaxFest2019-eiffel.png}%\hspace*{5cm}~%
...
\vspace{1em}
\includegraphics[height=4cm]{syntaxFest2019-eiffel.png}%\hspace*{5cm}~%
%\includegraphics[height=2cm]{sponsors_all.png}%\hspace*{5cm}~%
\end{center}

%\includegraphics[height=4cm]{sponsors_all.png}%\hspace*{5cm}~%
